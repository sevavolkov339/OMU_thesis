...
// пауза после того, как весь текст дописан — после неё сообщаем GameControllerO, что можно переходить дальше
...
// волна по буквам — как в текстах главного меню (MainMenuControllerO)
wave_timer = 0;
wave_amplitude = 2.5;
