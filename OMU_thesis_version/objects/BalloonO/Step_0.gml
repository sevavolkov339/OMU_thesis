...
//// когда шарик прямо над игроком (dir=90) → image_angle=0 (прямо)
//// когда шарик левее (dir>90) → наклон влево, и наоборот
...
// целевая позиция над игроком с флоатом (поднимается вместе с ним во время полёта)
var rest_x = owner.x;
