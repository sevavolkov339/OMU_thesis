// рисуем в Draw GUI, чтобы полосы ветра были видны всегда, поверх всего, независимо от
// того, на каком слое комнаты стоит сам объект. Координаты полос уже в GUI-пространстве
// (см. spawn_wind_line в Create_0) — никакой конвертации камеры тут больше не нужно
...
for (var i = 0; i < array_length(lines); i++) {
    ...
    // плавно появляются и плавно (и в разное время — у каждой своя life_max) пропадают
