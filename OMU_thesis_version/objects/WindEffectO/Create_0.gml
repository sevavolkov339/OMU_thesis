// порывы ветра для фона мира 2. Работает в паре со SnowFallEffectO
...
player_push = 0.15;
item_push = 0.6;
// насколько сильно гасится/прибавляется скорость при движении против/по ветру
player_headwind_brake = 0.5;
item_headwind_brake = 0.45;
player_tailwind_boost = 0.3;
item_tailwind_boost = 0.25;

// визуальные полосы ветра, считаются сразу в экранных (GUI) координатах, а не
lines = [];
max_lines = 25;
line_spawn_timer = 0;
